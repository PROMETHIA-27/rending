...
use rending_reflect::prelude::*;
use wgpu::util::{BufferInitDescriptor, DeviceExt};
use wgpu::{
    Backends, BindGroup, Buffer, BufferDescriptor, BufferUsages, CommandEncoder,
    CommandEncoderDescriptor, ComputePassDescriptor, ComputePipeline, DeviceDescriptor, Extent3d,
    Features, ImageCopyTexture, ImageDataLayout, InstanceDescriptor, Limits, MaintainBase, MapMode,
    Origin3d, PowerPreference, RequestAdapterOptions, ShaderSource, TextureAspect,
...
fn main() {
    ...
    let ascii_table = device.create_buffer_init(&BufferInitDescriptor {
        label: None,
        contents: &ascii_data,
